...
- Le véhicule est un utilitaire ou une commerciale selon son poids (>3,5 tonnes)
- Le pays d'où provient la voiture est la Belgique, la France ou l'Allemagne si l'immatriculation commence par `BE`,`FR` ,`DE`
...
Créer un fonction `rouler` qui fait "avancer la voiture de 100 000 km" et que l'usure passe de `low` à `high`
